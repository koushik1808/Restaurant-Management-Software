  ...
  <div class="row">
    <div class="col text-center">
      <div class="card mx-auto p-3">
        ...
        <a href="{{route('Admin.cancelBilling',['id'=>$table->id])}}"><button class="btn btn-primary my-4"> Cancel
            Billing</button></a>
        <a href="{{route('Admin.Billing_print2',['id'=>$table->id])}}"><button class="btn btn-primary my-4"> Complete
            Billing</button></a>
